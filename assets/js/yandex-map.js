...
function initMap(zoom, center, marker_position, drag) {
  ...
  ymaps.ready(function () {
    ...
    var place = new ymaps.Placemark(
      marker_position, {
        hintContent: 'Clinic template',
        balloonContent: '<h4><span style="font-weight:bold;font-size:20px;color:#e02025;">Clinic template</span></h4><b>Адрес:</b> Республика Татарстан, г. Набережные Челны<br><b>Телефоны:</b> сотовый: +7 (917) 111-11-11, +7 (917) 222-22-22<br><b>Е-mail:</b> clinic@mail.ru'
      }, {
        iconImageHref: 'http://design-aura.ru/templates/clinic/assets/images/locator.png',
